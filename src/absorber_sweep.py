...
from data.gd157_chain import CAPTURE_RATE, lambdas, n0
...
def sweep_interval_lengths(t_values, order=DEFAULT_ORDER):
    ...
    reference. Returns the max relative error and (sigma*phi)*T at each T.
    """
    ...
    return max_rel_errors, CAPTURE_RATE * t_values
